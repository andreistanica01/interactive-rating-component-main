...
function submitPts() {
    if (pt1.classList == "review-button-selected" || pt2.classList == "review-button-selected" || pt3.classList == "review-button-selected" || pt4.classList == "review-button-selected" || pt5.classList == "review-button-selected") {
        container.classList.add("display-none");
        submittedContainer.classList.remove("display-none");
    }
    if (pt1.classList == "review-button-selected") selectionParagraph.innerHTML = "You selected 1 out of 5";
    else if (pt2.classList == "review-button-selected") selectionParagraph.innerHTML = "You selected 2 out of 5";
    else if (pt3.classList == "review-button-selected") selectionParagraph.innerHTML = "You selected 3 out of 5";
    else if (pt4.classList == "review-button-selected") selectionParagraph.innerHTML = "You selected 4 out of 5";
    else if (pt5.classList == "review-button-selected") selectionParagraph.innerHTML = "You selected 5 out of 5";
}
